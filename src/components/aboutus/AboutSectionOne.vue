  ...
  <div
      ...
      <div class="text-center flex flex-col justify-center items-center max-w-4xl lg:text-center font-sans space-y-5">
        ...
        <div class="">
          <p class="text-white">
            ...
            harnessing the power of blockchain technology, mobile (iOS and Android), and web projects to drive
            transformative solutions. Our mission is to push the boundaries of technology, delivering cutting-edge
            products and services tailored to meet your needs. Discover how Beeone Innovation is shaping the future of
            technology with our commitment to innovation and excellence
          </p>
        </div>
    ...
    <div>
      <div style="background-color: #161616; border-radius: 70%/100px 100px 0 0"
        class="inset-x-0 bottom-0 absolute -z-10 transform-gpu md:h-[200px] h-[150px] overflow-hidden bg-[#161616]">
      </div>
      <div class="w-full">
