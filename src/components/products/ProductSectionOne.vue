<template>
  <div
    class="relative min-h-screen overflow-hidden w-full px-2 lg:px-12 py-10 lg:py-20 sm:py-38 justify-between items-center">
    <img class="absolute left-0 -z-50 top-0 hidden md:block" src="../../assets/img/mask2.webp" alt="" />
    <img class="absolute right-0 ro(tate-0 -z-50 -scale-x-100 top-0" src="../../assets/img/mask2.webp" alt="" />
    <div>
            ...
            <div class="p-5 space-y-5 2xl:gap-36 flex flex-col justify-between order-1">
              <div class="space-y-5">
                ...
                <p class="text-gray-50 text-md 2xl:text-xl text-justify">
                  ...
                  Techbank Movies London leads the charge in this cutting-edge
                  technology, enabling production companies to tap into fresh
                  revenue streams from their content while offering movie
                  enthusiasts the ability to acquire digital assets directly
                  through our platform.Join us as we pave the way for innovation
                  and growth in entertainment technology."
                </p>
              </div>
              <div class="relative">
            ...
            <div class="p-5 space-y-5 2xl:gap-36 flex flex-col justify-between order-1">
              <div class="space-y-5">
                ...
                <p class="text-gray-50 text-md 2xl:text-xl text-justify">
                  ...
                  convenient payments are no longer just a vision. DWallets
                  securely store digital assets and facilitate effortless
                  transactions, transforming the way we handle finances.
                  Leveraging our expertise, we've contributed to the development
                  of their iOS and Android applications, ensuring users
                  experience smooth and reliable functionality."
                </p>
              </div>
              <div class="relative">
            ...
            <div class="p-5 space-y-5 2xl:gap-36 flex flex-col justify-between order-1">
              <div class="space-y-5">
                ...
                <p class="text-gray-50 text-md 2xl:text-xl text-justify">
                  ...
                  transactions, transforming the way we handle finances.
                  Leveraging our expertise, we've contributed to the development
                  of their iOS and Android applications, ensuring users experience
            ...
            <div class="p-5 space-y-5 2xl:gap-36 flex flex-col justify-between order-1">
              <div class="space-y-5">
                ...
                <p class="text-gray-50 text-md 2xl:text-xl text-justify">
                  ...
                  decentralized finance, DBANK is reshaping the cryptocurrency
                  landscape. Leveraging transparent smart contract technology,
                  DBANK guarantees complete decentralization, making it accessible
                  to everyone. Embrace the future of DeFi with DBANK, accessible
                  through any web 3.0 browser or Dapp. Join us and witness the
            ...
            <div class="p-5 space-y-5 2xl:gap-36 flex flex-col justify-between order-1">
              <div class="space-y-5">
                ...
                <p class="text-gray-50 text-md 2xl:text-xl text-justify">
                  ...
                  our website, Techbank facilitates seamless storage and exchange
                  of multiple cryptocurrencies on a single platform. Experience
                  the convenience of managing your digital assets effortlessly
                  with Techbank."
                </p>
              </div>
              <div class="gap-5 flex flex-wrap md:flex-nowrap w-full">
            ...
            <div class="p-5 space-y-5 2xl:gap-36 flex flex-col justify-between order-1">
              <div class="space-y-5">
                ...
                <p class="text-gray-50 text-md 2xl:text-xl text-justify">
                  ...
                  opportunities for immigrants, and our website development and
                  digital marketing solutions have empowered them to dominate the
                  online landscape.
                </p>
              </div>
              <div class="relative">
