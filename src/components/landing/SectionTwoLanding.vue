  ...
  >
    ...
    <div>
      <div class="flex flex-wrap gap-5 justify-center mt-5">
        <div
          class="p-[1px] bg-gradient-to-br from-green-500 via-blue-200 transition-all duration-1000 hover:skew-y-3 hover:-skew-x-3 to-purple-600 rounded-xl"
        >
          <div class="max-w-[280px] flex flex-col justify-between h-full space-y-4 bg-[#171717] p-5 rounded-xl">
            ...
            <button class="ring-1 text-white ring-white rounded-md px-5 py-2">
              learn more
            </button>
          </div>
        </div>
